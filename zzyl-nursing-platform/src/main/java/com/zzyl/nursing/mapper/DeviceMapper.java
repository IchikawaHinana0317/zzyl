...
public interface DeviceMapper extends BaseMapper<Device>
{
     ...
     * 查询同一位置是否已经绑定相同产品
     */
    public int countSameProductAtLocation(
            @Param("productKey") String productKey,
            @Param("bindingLocation") Long bindingLocation,
     ...
     * @return 设备
     */
    public Device selectDeviceByIoTId(String iotId);
